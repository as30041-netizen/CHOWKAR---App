...
import { Send, Phone, CheckCircle, ArrowLeft, LockKeyhole, Paperclip, MoreVertical, Check, CheckCheck, Languages, Mic, MicOff, Loader2, Sparkles, Lock, Volume2, Square } from 'lucide-react';
                    ...
                    <div key={msg.id} className={`flex ${isMe ? 'justify-end' : 'justify-start'}`}>
                        <div className="flex items-end gap-1 max-w-[85%]">
                            ...
                            {isMe && (
                                <button
                                    onClick={() => handleSpeakMessage(msg)}
                                    className={`p-1.5 mb-1 rounded-full shadow-sm transition-all ${isThisSpeaking ? 'bg-red-50 text-red-500' : 'bg-white/80 hover:bg-white text-gray-600'}`}
                                    title="Listen"
                                >
                                    {isThisSpeaking ? <Square size={12} fill="currentColor"/> : <Volume2 size={12}/>}
                                </button>
        ...
        <div className="p-3">
            ...
            <div className="flex items-end gap-2">
                ...
                <button 
                    ...
                    className={`p-3 rounded-full shadow-md transition-all transform hover:scale-105 active:scale-95 ${
                        inputText.trim() 
