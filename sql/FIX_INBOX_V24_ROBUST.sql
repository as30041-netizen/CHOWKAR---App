-- ============================================
-- FIX INBOX V24 (ULTRA-ROBUST & STATUS-AWARE)
-- 1. Fixed NULL counterpart detection in messages
-- 2. Robust Participant detection (Poster + Hired Worker)
-- 3. Strict 'OPEN' job exclusion from Inbox
-- 4. Case-insensitive participant matching
-- ============================================
...
DO $$ BEGIN
  RAISE NOTICE '✅ V24 Ultra-Robust Inbox Deployed.';
END $$;
