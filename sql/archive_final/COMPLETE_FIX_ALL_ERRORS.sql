-- ============================================================================
-- CHOWKAR COMPLETE DATABASE MIGRATION
-- Run this ONCE in your Supabase SQL Editor to fix all errors
-- ============================================================================

-- ============================================================================
-- 1. GET HOME FEED RPC (Fixes 404 error)
-- ============================================================================
-- Drop ALL existing get_home_feed functions (handles multiple overloaded versions)
DO $$ 
DECLARE 
    r RECORD;
BEGIN
...
-- ============================================================================
-- Drop ALL existing get_job_bids functions (handles multiple overloaded versions)
DO $$ 
DECLARE 
    r RECORD;
BEGIN
