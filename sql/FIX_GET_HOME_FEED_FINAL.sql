-- ============================================
-- FIX: Drop ALL get_home_feed functions
-- ============================================
-- This removes all overloaded versions
-- ============================================

-- Drop all possible signatures
DROP FUNCTION IF EXISTS get_home_feed(UUID);
DROP FUNCTION IF EXISTS get_home_feed(UUID, INT);
DROP FUNCTION IF EXISTS get_home_feed(UUID, INT, INT);
DROP FUNCTION IF EXISTS get_home_feed(UUID, INT, INT, TEXT);
DROP FUNCTION IF EXISTS get_home_feed(UUID, INT, INT, TEXT, BOOLEAN);
DROP FUNCTION IF EXISTS get_home_feed(TEXT);
...
DO $$ 
BEGIN 
    RAISE NOTICE '✅ get_home_feed RPC created successfully';
    RAISE NOTICE '   All duplicate versions removed';
END $$;
