-- ============================================================================
-- SQL: AMBIGUOUS COLUMN FIX (Phase 51)
-- Purpose: Resolve "column reference poster_name is ambiguous" error.
--          Explicitly selects columns from jobs and profiles.
-- ============================================================================
...
BEGIN
  ...
  WHERE 
    -- STRICT FILTER: In RECOMMENDED mode, only show recommended jobs
    (p_feed_mode != 'RECOMMENDED' OR fj.is_rec = TRUE)
  ORDER BY 
