-- ============================================================================
-- SQL: CATEGORY VISIBILITY FIX (Phase 51.1)
-- Purpose: Ensure category browsing works even in RECOMMENDED mode.
--          If a category is explicitly requested, we don't force is_rec=true.
-- ============================================================================
...
BEGIN
  ...
  SELECT 
    ...
    fj.job_date::TIMESTAMPTZ, fj.j_dur, fj.j_bud, UPPER(fj.j_stat::TEXT) as status, fj.j_img,
    fj.j_created,
    fj.b_count,
    fj.b_id,
    fj.is_rec,
